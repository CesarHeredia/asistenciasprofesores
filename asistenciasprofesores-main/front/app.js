...
async function loadDashboard() {
  ...
  try {
    if (window.eel) {
      ...
      rawDashboardData = [
        {id_profesor: 1, nombre: "Dr. Carlos Rodríguez", materia: "Algoritmos Avanzados", aula: "101-B", facultad: "Ingeniería", avatar: "🧔🏽"},
        {id_profesor: 2, nombre: "Dra. Ana Pérez", materia: "Introducción a la Física", aula: "205", facultad: "Ciencias Exactas", avatar: "👩🏻"},
        {id_profesor: 3, nombre: "Lic. Sofía Martínez", materia: "Historia del Arte", aula: "310", facultad: "Humanidades", avatar: "👩🏽"},
        {id_profesor: 4, nombre: "Ing. David Chen", materia: "Programación de Sistemas", aula: "G-01", facultad: "Ingeniería", avatar: "👨🏻"}
      ];
    }
...
function renderCards(data) {
  ...
  data.forEach(p => {
    const status = getCurrentStatus(p.schedule_slots || []);
    ...
    card.innerHTML = `
      ...
      <div class="card-details">
        <div class="detail-row">
          ...
          <span class="detail-value">${p.materia || 'No asignada'}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Aula:</span>
          <span class="detail-value">${p.aula || 'No asignada'}</span>
        </div>
        <div class="detail-row">
